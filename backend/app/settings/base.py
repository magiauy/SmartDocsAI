...
RETRIEVAL_STORE_BACKEND = os.getenv("RETRIEVAL_STORE_BACKEND", "qdrant")
NEO4J_URI = os.getenv("NEO4J_URI", "bolt://localhost:7687")
NEO4J_USER = os.getenv("NEO4J_USER", "neo4j")
NEO4J_PASSWORD = os.getenv("NEO4J_PASSWORD", "")
NEO4J_DATABASE = os.getenv("NEO4J_DATABASE", "neo4j")
NEO4J_VECTOR_INDEX_NAME = os.getenv("NEO4J_VECTOR_INDEX_NAME", "smartdocsai_chunk_embedding_index")
NEO4J_VECTOR_SIMILARITY = os.getenv("NEO4J_VECTOR_SIMILARITY", "cosine")
